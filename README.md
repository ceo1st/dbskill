...
[![Version](https://img.shields.io/badge/version-2.17.11-111111.svg)](VERSION)
...
dbskill 由 [dontbesilent](https://x.com/dontbesilent) 创建。从 16,152 条公开推文中筛选、结构化出 4,176 个知识原子，并将其中的方法沉淀为 27 个可直接调用的 Skills。
...
完整的 27 个 Skill、适用时机、输入示例和常见衔接方式，见 [新手入门与 Skill 全目录](docs/新手入门.md#skill-全目录)。
